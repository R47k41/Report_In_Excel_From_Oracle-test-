...
namespace NS_ExcelReport
{
	...
	//массив строк для вставки строк в файл(т.к. библиотека сильно долго добавляет новую строку в файл)
	//строка для вставки: приемник, источник
...
//	using TConvertType = std::pair<NS_Oracle::TType, size_t>;
	...
	protected:
		...
		//функция определения является ли строка строкой форматов данных:
	...
	public:
		...
		//функция копирования массива отфильтрованных строк:
		static bool copyRowsArr(TRowsFlag& dst, NS_ExcelReport::TRowsFlag& src, 
			size_t key_to, bool only_true = true) noexcept(true);
		//функция увеличения значения ключей массива строк(используется при вставке строки):
	...
	protected:
		...
		//функция добавления новых строк в файл:
