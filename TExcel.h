...
namespace NS_Excel
{
	...
	private:
		...
		//функиция определения является ли формат ячейки форматом double-значения:
	...
	public:
		...
		//функция проверки наличия данных на странице:
		...
		//считывание данных из ячейки в строковом формате:
		...
		//выделение текста в ячейке жирным шрифтом:
	...
	public:
		...
		//проверка формата значения в виде double-числа: %d.dd
